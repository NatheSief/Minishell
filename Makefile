...
#    Updated: 2024/12/01 19:04:41 by nsiefert         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# ================================ SRC FILES ================================= #
SRCS 			:=	$(addprefix $(SRCS_PATH),$(shell find $(SRCS_PATH) -name "*.c"))
...
$(NAME): libft $(OBJS)
	...
	@echo "\n\n\n[🔘] $(BGREEN)$(PROJECT_NAME) Ready to eat$(NC)\n"
...
$(OBJS_PATH)%.o: $(SRCS_PATH)%.c
	...
	@printf "\b\b\b\b\b$(A_BLACK)$(WHITE_BG)$(BOLD)%3d%%$(NC)\r"
